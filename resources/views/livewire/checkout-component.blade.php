            ...
            <div class="container">
                ...
                <form>
                    <div class="row">
                            <div class="col-md-6">
                                <div class="mb-25">
                                    <h4 class="billing-details">Billing Details</h4>
                                </div>
                                <form method="post" wire:submit.prevent="placeOrder">
                                    ...
                                    <div class="form-group">
                                        <input required="" type="email" name="email" placeholder="Your email" wire:model="email">
                                        @error('email') <span class="text-danger">{{ $message }}</span>
                                        
                                    @enderror
                                    </div>
                                    <div class="form-group">
                                        <input required="" type="number" name="phone" placeholder="12 digits format" wire:model="mobile">
                                    ...
                                    <div class="form-group">
                                        <input required="" type="text" name="zipcode" placeholder="Postcode / ZIP *" wire:model="xipcode">
                                    ...
                                    {{-- <div class="form-group">
                                        <input required="" type="text" name="phone" placeholder="Phone *" wire:model="email">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="ship_detail">
                                            <div class="form-group">
                                                <div class="chek-form">
                                                    <div class="custome-checkbox">
                                                        <input class="form-check-input" type="checkbox" name="checkbox"
                                                            id="differentaddress" value="1" wire:model="ship_to_different">
                                                        <label class="form-check-label label_info" data-bs-toggle="collapse"
                                            ...
                                            <div id="collapseAddress" class="different_address collapse in">
                                                ...
                                                <div class="form-group">
                                                    <input type="email" required="" name="email" placeholder="Your Email *" wire:model="s_email">
                                                    @error('s_email') <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <div class="form-group">
                                                    <input type="number" required="" name="phone" placeholder="12 digits format *" wire:model="s_mobile">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            @if (Session::has('shop.checkout'))
                                                <th>Total</th>
                                                <td colspan="2" class="product-subtotal"><span class="font-xl text-brand fw-900">${{ Session::get('shop.checkout'){'total'} }}</span></td>
                                                @endif
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="payment_method">
                                    ...
                                    <div class="payment_option">
                                        <div class="custome-radio">
                                            <input class="form-check-input" required="" value="cod" type="radio" wire:model="paymentmode" name="payment_option" id="exampleRadios3">
                                        ...
                                        <div class="custome-radio">
                                            <input class="form-check-input" required="" value="card" type="radio" wire:model="paymentmode" name="payment_option" id="exampleRadios4">
                                        ...
                                        <div class="custome-radio">
                                            <input class="form-check-input" required="" value="paypal" type="radio" wire:model="paymentmode" name="payment_option" id="exampleRadios5">
